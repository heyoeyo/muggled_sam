...
from .image_encoder_model import SAMImageEncoder
from .coordinate_encoder_model import SAMCoordinateEncoder
from .prompt_encoder_model import SAMPromptEncoder
from .mask_decoder_model import SAMMaskDecoder
...
def make_sam_from_original_state_dict(original_state_dict: dict | str, strict_load=True) -> [dict, SAMModel]:
    """
    Function used to initial a SAM model from a state dictionary (i.e. model weights) file.
    ...
    sam_model = make_sam(**model_config_dict)
...
def make_sam(
    ...
    # vit-huge:
        ...
        features_per_prompt_token = 256
        features_per_decoder_token = 128
        mask_decoder_mlp_dimension = 2048
        num_output_mask_tokens = 4
        num_decoder_blocks = 2
    ...
    return SAMModel(imgenc_model, coordenc_model, promptenc_model, maskdec_model)
