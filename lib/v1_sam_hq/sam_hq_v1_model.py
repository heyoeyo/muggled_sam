...
from .image_encoder_model import SAMHQV1ImageEncoder
from .coordinate_encoder_model import SAMHQV1CoordinateEncoder
from .prompt_encoder_model import SAMHQV1PromptEncoder
from .mask_decoder_model import SAMHQV1MaskDecoder
...
class SAMHQV1Model(nn.Module):
    """
    Wrapper around separated SAM-HQ model components, so that the model can be used as a singular entity
    """
    ...
    def __init__(
        self,
        image_encoder_model: SAMHQV1ImageEncoder,
        coordinate_encoder: SAMHQV1CoordinateEncoder,
        prompt_encoder_model: SAMHQV1PromptEncoder,
        mask_decoder_model: SAMHQV1MaskDecoder,
    ):
    ...
    def encode_image(
        ...
        with torch.inference_mode():
            ...
            encoded_images = self.image_encoder(image_rgb_normalized_bchw)

        # Get patch sizing of the encoded image tokens (as needed by other components)
        patch_grid_hw = encoded_images[0].shape[2:]

        return encoded_images, patch_grid_hw, image_preenc_hw

    # .................................................................................................................

    def generate_masks(
        self,
        encoded_images: Tensor,
        ...
        with torch.inference_mode():
            ...
            mask_preds, iou_preds, _ = self.mask_decoder(
                encoded_images, encoded_prompts, grid_posenc, mask_hint, blank_promptless_output
            )
