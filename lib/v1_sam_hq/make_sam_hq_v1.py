...
from .sam_hq_v1_model import SAMHQV1Model
...
def make_samv1_from_original_state_dict(
    ...
    """
    Function used to initialize a SAM-HQ (v1) model from a state dictionary (i.e. model weights) file.
    ...
    sam_model = make_sam_hq_v1(**model_config_dict)
...
def make_sam_hq_v1(
    ...
    imgenc_model = SAMHQV1ImageEncoder(
    ...
    coordenc_model = SAMHQV1CoordinateEncoder(features_per_prompt_token)

    promptenc_model = SAMHQV1PromptEncoder(features_per_prompt_token)

    maskdec_model = SAMHQV1MaskDecoder(
        features_per_prompt_token,
    ...
    return SAMHQV1Model(imgenc_model, coordenc_model, promptenc_model, maskdec_model)
