...
class GenericAttention(nn.Module):
    ...
    https://github.com/facebookresearch/sam3/blob/757bbb0206a0b68bee81b17d7eb4877177025b2f/sam3/sam/transformer.py#L185
    """
    ...
    def __init__(
        ...
        internal_features: int | None = None,
        ...
        assert internal_features % num_heads == 0, "num_heads must divide evenly into features_per_token"
        ...
        self.k_proj = nn.Linear(features_per_kv_token, internal_features)
        self.v_proj = nn.Linear(features_per_kv_token, internal_features)
...
class CrossAttentionNormed(nn.Module):
    ...
    computation exists as a recurring pattern throughout the 'TwoWayTransformer'
    As an example of the pattern this module represents, see this code block:
    https://github.com/facebookresearch/sam3/blob/757bbb0206a0b68bee81b17d7eb4877177025b2f/sam3/sam/transformer.py#L100-L104
    """
