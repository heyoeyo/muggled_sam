...
def make_samv3p1_from_muggled_state_dict(
    ...
    saved from a muggled-SAMV3.1 instance, rather than the original model weights.
...
def make_sam_v3p1(
    ...
    imgenc_model = SAMV3p1ImageEncoder(
        imgencoder_features,
    ...
    # Video components
    memenc_model = SAMV3p1MemoryEncoder(
        features_per_prompt_token,
    ...
    txtenc_model = SAMV3p1TextEncoder(
        txtencoder_features,
    ...
    sample_model = SAMV3p1SamplingEncoder(features_per_detection_token, samplingenc_num_blocks, samplingenc_num_heads)
    imgexm_model = SAMV3p1ImageExemplarFusion(features_per_detection_token, imgexmfuse_num_blocks, imgexmfuse_num_heads)
    exmdet_model = SAMV3p1ExemplarDetector(
        features_per_detection_token,
