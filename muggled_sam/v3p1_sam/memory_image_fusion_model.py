...
class SAMV3p1MemoryImageFusion(nn.Module):
    ...
    def forward(
        ...
        flat_imgtokens_bnc_with_posenc = image_posenc_tokens.flatten(2).permute(0, 2, 1)
...
class ImageTokenPositionEncoder(nn.Module):
    ...
    def __init__(self, features_per_image_token: int = 256, position_encoding_weight: float = 0.1):
        super().__init__()
