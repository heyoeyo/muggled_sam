...
class SAMV3Core(nn.Module):
    """
    Holds core SAMv3 model components.
    ...
    def initialize_video_masking(
        ...
        mem_b1hw, ptr_b1c = encoded_mem
        return mask_b1hw, mem_b1hw, ptr_b1c
    ...
    def step_video_masking(
        ...
        new_prompt_mem_list = list(zip(pmt_mem[pmt_slice], pmt_ptrs[pmt_slice]))
        new_frame_mem_list = list(zip(prv_mem[prv_slice], prv_ptrs[prv_slice]))
        ...
        memenc_b1hw, ptr_b1c = encoded_memory
        return obj_score_b, best_mask_idx, masks_bnhw, memenc_b1hw, ptr_b1c
...
class SAMV3InteractiveModel(nn.Module):
    ...
    def generate_masks(
        self,
        encoded_image: SAMv3ImageEncoding,
        encoded_prompts: Tensor,
        mask_hint: Tensor | int | None = None,
        blank_promptless_output: bool = True,
    ) -> tuple[Tensor, Tensor]:
...
class SAMV3TrackingModel(nn.Module):
    ...
    ) -> tuple[Tensor, SAMv3MemoryEncoding]:
        """
    ...
    def encode_frame_memory(
        ...
        This function roughly corresponds to `_encode_new_memory` in the original SAMv3 implementation:
        https://github.com/facebookresearch/sam3/blob/757bbb0206a0b68bee81b17d7eb4877177025b2f/sam3/model/sam3_tracker_base.py#L797
        ...
        with _inference_mode(self._infmode):
            ...
            if best_objptr_b1c is None:
                ...
                best_objptr_b1c = self.mask_decoder.make_pointer_from_mask(
                    v12_encimgs, pad_prompt_enc, grid_posenc, best_mask_b1hw
                )

            # Bundle tensors as a single output
            encoded_memory = (memenc_bchw, best_objptr_b1c)
    ...
    def step_video_masking(
        self,
        encoded_image: SAMv3ImageEncoding,
        prompt_memory_encodings: list[SAMv3MemoryEncoding] | SAMv3MemoryEncoding,
        frame_memory_encodings: list[SAMv3MemoryEncoding] | SAMv3MemoryEncoding,
