...
class SAMV3MemoryImageFusion(nn.Module):
    ...
    def _prepare_reshaped_pointers(
        ...
        https://github.com/facebookresearch/sam3/blob/757bbb0206a0b68bee81b17d7eb4877177025b2f/sam3/model/sam3_tracker_base.py#L757-L761
...
class MemoryConcatenator(nn.Module):
    ...
    def __init__(
        ...
        # Setup image-like position encoder & pointer position encoder
