...
class MaskDecoderTransformer(nn.Module):
    ...
    The code here is originally adapted from the segment-anything (v1) repo, though a v3 implementation also exists:
    ...
    https://github.com/facebookresearch/sam3/blob/757bbb0206a0b68bee81b17d7eb4877177025b2f/sam3/sam/transformer.py#L16
...
class MLP2LayersNormed(nn.Module):
    ...
    https://github.com/facebookresearch/sam3/blob/757bbb0206a0b68bee81b17d7eb4877177025b2f/sam3/sam/common.py#L9
    ...
    There are several (minor) changes in this implementation:
        ...
        - A layernorm has been added on the output, as this matches the other attention blocks where it is used
          see: https://github.com/facebookresearch/sam3/blob/757bbb0206a0b68bee81b17d7eb4877177025b2f/sam3/sam/transformer.py#L171-L173
    """
